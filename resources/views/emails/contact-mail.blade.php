          ...
          <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
            <tr>
              <td class="email-masthead">
                <a href="https://vir-za.com" class="f-fallback email-masthead_name">
                    <img src="https://vir-za.com/wp-content/uploads/2021/12/virzaOk.gif" alt="" class="custom-logo">
                </a>
              </td>
            </tr>
            <!-- Email Body -->
                          ...
                          <tr>
                            <td class="attributes_content">
                              <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                ...
                                <tr>
                                  <td class="attributes_item">
                                    <span class="f-fallback"><strong>Thanks! </strong></span>
                                  </td>
                                </tr>
                              </table>
                            </td>
           ...
           https://litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design -->
                              <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                <tr>
                                  <td align="center">
                                    <a href="#" class="f-fallback button button--green" target="_blank"><p><span style="color: rgb(247, 247, 247);">Your message details</span></p></a>
                                  </td>
                                </tr>
                              </table>
                            </td>
                              ...
                              <table class="purchase_content" width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                  <th class="purchase_heading" align="left">
                                    <p class="f-fallback">Name: {{$contact->name}}</p>
